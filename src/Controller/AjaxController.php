...
class AjaxController extends InitializableController
{
    ...
    public function getruleajax()
    {
        ...
        if ($element_id1 and $element_id2) {
            ...
            $elements = $this->getRepository(Element::class)->findAll();
            return $this->render('answerajax.html.twig', array('rules_arr' => $rules_arr, 'element1' => $element1, 'element2' => $element2, 'elements' => $elements));
